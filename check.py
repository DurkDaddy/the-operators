...
allowed={'index.html','learn-more/index.html','404.html','sitemap.xml','robots.txt','.nojekyll'}|{'assets/'+s for s in ['site.css','favicon.svg','operators-logo.png','durkin.png','graffiti.jpg','agent-talent-graffiti.png','marker.ttf','FONT-LICENSE-Marker.txt']}
...
if 'agent-talent-graffiti.png' not in (OUT/'index.html').read_text():errors.append('Agent and talent mural is missing')
